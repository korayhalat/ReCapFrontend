...
@Component({
    ...
    template: `<ng-container  *ngIf="isAuthenticated()">
    <p-menubar [model]="items">
        <button type="button" class="p-button-secondary" pButton pRipple icon="pi pi-bars" 
        label="{{user.userName}}" (click)="menu.toggle($event)"></button>
